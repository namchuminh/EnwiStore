                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material mx-2" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Nhập mã chuyên mục" class="form-control form-control-line" required name="maloai"> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Tên chuyên mục</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Nhập tên chuyên mục" class="form-control form-control-line" required name="tenloai">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
